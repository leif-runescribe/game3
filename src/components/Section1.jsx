...
const Section1 = () => {
  const items = [
    ...
    },
    {
      ...
      description:
        "More engaged players with global contests increasing retention by 30%",
    },
    {
      id: 3,
      src: "/8.jpg",
  ...
  return (
    <>
      <div className="bg-black w-full text-white pb-28 py-28 md:py-4 text-center md:text-left">
        <div className=" px-40 flex flex-col  w-full h-full">
          ...
          <div className="grid sm:grid-cols-1 lg:grid-cols-3 gap-10 sm:px-5">
            {items.map(({ id, src, link, title, description }) => (
              <div
                key={id}
                className="relative shadow-md shadow-gray-500 rounded-lg overflow-hidden fixed-size"
              >
                <img
                  src={src}
